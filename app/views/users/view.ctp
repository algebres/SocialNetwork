...
<h2><?php  __('User');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Avatar Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $user['User']['avatar_id']; ?>
			&nbsp;
		</dd>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Relationship Status Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $user['User']['relationship_status_id']; ?>
			&nbsp;
		</dd>
